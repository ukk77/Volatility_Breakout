...
> `volatility_breakout` · 18 files (python×18) · 19 classes · 23 functions · ~1,320 source lines
...
- `«dataclass» class FalseBreakoutConfig`  — Post-entry filter to detect and exit failed breakouts early.
